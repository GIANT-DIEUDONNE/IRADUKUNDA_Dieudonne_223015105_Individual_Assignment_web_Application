...
<head>
    ...
    <title>DIEUDONNE_IRADUKUNDA HOTEL</title>
    <style>
        :root {
            --bg: #eef7ff;
            --bg-soft: #f7fbff;
...
<body>
        ...
        <div class="container">
            <div class="hero-panel">
                <div class="hero-copy">
                    ...
                    <h1>Welcome to Bahati hotel </h1>
                    <p>Enjoy refined comfort, signature meals, and a warm atmosphere designed to turn every visit into a memorable experience.</p>
    ...
    <div class="container">
        ...
        <div class="section about-card" id="about">
            <h2>About Us</h2>
            <p>We provide quality food and comfortable accommodation for our guests.
Welcome to our hotel, where comfort meets elegance and every stay becomes a memorable experience. Nestled in a serene and inviting environment, our hotel is designed to offer both relaxation and luxury to every guest. From beautifully furnished rooms to exceptional customer service, we take pride in creating a warm and welcoming atmosphere that feels like a home away from home. Whether you are visiting for business or leisure, our modern facilities, delicious cuisine, and dedicated staff ensure that your needs are met with care and professionalism. At our hotel, we don’t just provide a place to stay we create moments you’ll cherish.
        ...
        <div class="section menu-card" id="menu">
            ...
            <table>
                ...
                <tr><td>Drink</td><td>FRW200 </td></tr>
                <tr><td>Fresh Juice</td><td>FRW 3000</td></tr>
        ...
        <div class="section gallery-card" id="gallery">
            <h2>Gallery</h2>
            <div class="gallery">
                <a href="#order"><img src="image/IMAGE1.png" alt="Gallery image 1"></a>
                <a href="#order"><img src="image/IMAGE2.png" alt="Gallery image 2"></a>
                <a href="#order"><img src="image/IMAGE3.png" alt="Gallery image 3"></a>
                <a href="#order"><img src="image/IMAGE4.png" alt="Gallery image 4"></a>
                <a href="#order"><img src="image/IMAGE5.png" alt="Gallery image 5"></a>
            </div>
        </div>
